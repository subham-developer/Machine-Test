  ...
  <div class="row">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <form method="POST" action="/category/upsert">
            @csrf
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">Category Name:</div>
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"><input type="text" class="form-control" value="<?php if(isset($data[0]['name'])){echo $data[0]['name'];} ?>" name="name">
              ...
              <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">Description:</div>
                  <div class="col-md-12 col-lg-12 col-xs-12 col-sm-12">
                    <textarea class="form-control" style="width: 100%;height: 128px;" name="cat_description"><?php if(isset($data[0]['cat_description'])){echo $data[0]['cat_description'];} ?>
                    </textarea>
                  </div>
              </div>
              <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">&nbsp;</div>
